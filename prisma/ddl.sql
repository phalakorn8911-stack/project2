...
INSERT INTO "roles" ("id", "name", "description") VALUES
  ('20000001-0000-4000-8000-000000000001', 'admin',    'ผู้ดูแลระบบ/ผู้บังคับบัญชา - เข้าดู แก้ไข และสั่งการได้ทั้งหมดของระบบ'),
  ('20000001-0000-4000-8000-000000000005', 'mechanic', 'ช่างซ่อม - เข้าระบบ แก้ไขงานในส่วนของช่าง'),
  ('20000001-0000-4000-8000-000000000004', 'driver',   'พลขับ - เข้าส่วนพลขับ แจ้งอาการเสียของรถให้ช่างซ่อม')
